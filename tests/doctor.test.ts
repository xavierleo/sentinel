...
describe('doctor checks', () => {
  it('reports ok when database, audit, model, and scheduler checks pass', async () => {
    ...
    expect(result.checks.map((check) => check.name)).toEqual(['database', 'auditLog', 'model', 'scheduler']);
  });
